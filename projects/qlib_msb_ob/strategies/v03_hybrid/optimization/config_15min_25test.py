...
OPTIMIZATION_CONFIG = {
    ...
    # 数据集划分 - 修改为 2025 测试，2023-2024 验证
    'data_split': {
        'test_year': [2025],           # 测试集（用于优化）
        'validate_years': [2023, 2024], # 验证集（用于验证）
    },
    ...
    # 验证配置
    'validation': {
        'overfitting_threshold': 0.20,  # 测试集vs验证集性能差异阈值20%
...
if __name__ == '__main__':
    print("V03混合策略参数优化配置 - 15分钟周期 (2025测试, 2023-2024验证)")
    print("="*80)
    print("\n参数空间:")
    ...
    print("\n数据划分:")
    print(f"  测试集（优化）: {OPTIMIZATION_CONFIG['data_split']['test_year']}")
    print(f"  验证集: {OPTIMIZATION_CONFIG['data_split']['validate_years']}")
